...
public class CharacterNavMovement : MonoBehaviour, IMovable
{
    ...
    public bool needChangeNumberPath;
    ...
    {
        TryRotation(other, true);
    }

    private void OnTriggerExit(Collider other)
    {
        TryRotation(other, false);
    }
    ...
    {
        if (newPosition == null || agent.destination == newPosition) return;
    ...
    private void TryRotation(Collider other, bool start)
    {
